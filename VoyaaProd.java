...
//        driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("sardaRRR@@@1996");
        ...
        driver.findElement(By.xpath("//input[@placeholder='Email or Mobile Number']")).sendKeys("seethinisowjanya421@gmail.com");
        driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("Srinu@143");
    ...
    public void aboutUs() {
        ...
        String expectedhomeURL="https://voyaah.com/#/about-us";
    ...
    public void staycation() {
        ...
        String expectedhomeURL="https://voyaah.com/#/staycation";
        String actualhomeURL=driver.getCurrentUrl();
        if(expectedhomeURL.equals(actualhomeURL)) {
    ...
    public void featuredPackage() {
        ...
        act.perform();
        Package.click();
//        String expectedhomeURL="https://voyaah.com/#/staycation/EASTENDMUNNARKERALA354787";
        String expectedhomeURL="https://voyaah.com/#/staycation/EASTENDMUNNARKERALA408827";
        String actualhomeURL=driver.getCurrentUrl();
        if(expectedhomeURL.equals(actualhomeURL)) {
